...
<div class="container">
	...
	<a href="{{url('admin/kursus')}}"><button type="button" class="btn btn-success" name="button">Back</button></a><hr>
			...
			<div class="row">
							...
							<div class="panel-body">
								...
								<div class="form-group">
									...
									<input type="number" name="email_pemesan" class="form-control" readonly="true">
								</div>
								<div class="form-group">
									<h4><span class="label label-default">Hari Tanggal: </span></h4>
									<input type="date" name="alamat_pemesan" class="form-control">
								</div>
								<div class="form-group">
